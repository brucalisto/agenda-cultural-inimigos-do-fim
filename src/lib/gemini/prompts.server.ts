...
18. Extraia telefone e Instagram separadamente. Procure primeiro o contato específico da atividade; se não houver, use o contato institucional explícito no material. Quando o conteúdo trouxer PERFIL/FONTE MONITORADA com uma URL de Instagram e não houver Instagram mais específico para a atividade, use o @usuario desse perfil como contact_instagram. Normalize telefone brasileiro mantendo DDD e número; Instagram deve ser @usuario quando identificável.
